...
$query = "select distinct month,mname,issue from article where year='$year' order by month";
...
for($i=1;$i<=$num_rows;$i++)
{
	...
	echo "<li class=\"volspan\"><a href=\"toc.php?year=$year&month=$month&id=$id\"><span class=\"sml\">$md</span><br /><span class=\"sml\">($id)</span></a></li>";
}
?>									
					</ul>
				</div>
